...
{  
   ...
   for(int i = 0 ; i < pSize ; i++)
   {
      ...
      cout<<setprecision(6)<<i+1<<" "<<fit[i]<<endl;
      sumFit = 0;
   }
   ...
   for(int i = 0 ; i < gen ; i++)
   {
	  ...
	  //------------------------------------------------------------------------------------------------------------------------
      //Selection Operation (Ranking Selection)
      //------------------------------------------------------------------------------------------------------------------------
    ...
    //****************************************** New ******************************************
    //Instead of output the final gen lowest, now output the lowestGene in the experiment,
    //it will check and compare it after Replacement Operation - It depends on how Replacement
